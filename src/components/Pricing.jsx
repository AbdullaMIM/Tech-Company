           ...
           <div className='max-w-[1240px] mx-auto py-12'>
            ...
            <div className='grid md:grid-cols-2'>
                ...
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <div>
                        <p className='text-6xl font-bold py-4 flex'>$39<span className='text-xl text-slate-500 flex flex-col justify-end'>/project</span></p>
                    </div>
                ...
                <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                    ...
                    <div>
                        <p className='text-6xl font-bold py-4 flex'>$79<span className='text-xl text-slate-500 flex flex-col justify-end'>/project</span></p>
                    </div>
                    <p className='text-2xl py-8 text-slate-500'>Get the STANDARD package for following services.</p>
